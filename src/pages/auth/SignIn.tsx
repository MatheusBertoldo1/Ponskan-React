...
export const SignIn = () => (
        <div className="flex flex-col w-full lg:max-w-[60vw] h-full max-h-120 overflow-hidden bg-white border border-black/10 rounded-3xl">
            <div className="flex  w-full h-25 pl-8 items-center left-0 top-0 bg-amber-400">
                <Link to={"/"}>
